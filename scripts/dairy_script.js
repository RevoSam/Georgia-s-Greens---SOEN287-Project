...
function updatePrice(){
    document.getElementById("total").value = (parseFloat(document.getElementById("price").innerText) * document.getElementById("quantity-text").value).toFixed(2) + "$";
}
...
document.getElementById("quantity-text").addEventListener("keyup",change_updatePrice);
